        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="TF">Faculty Id</label>
                        <input type="text" class="form-control" id="facultyno" name="TF" placeholder="Faculty Id ...">
                    </div>
                    <div class="form-group">
                        <label for="TF">Subject</label>
                        <input type="text" class="form-control" id="alias_name" name="AL" placeholder="Subject ...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="teacheremailid" name="TE"
                               placeholder="abc@galgotiasuniversity.edu.in ...">
                    </div>
                    <div align="right">
